...
pygame.display.set_caption('Spirites and Sound')
...
while True:
    ...
    for event in pygame.event.get():
        ...
        # draw black background onto the surface
        ...
        # check if the block has intersect with any food squares
        for food in foods[:]:
...
# TODO: Add rotten berry and able to shoot
