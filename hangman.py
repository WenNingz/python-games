...
def getRandomWord(wordDict):
    # Returns a random string from the passed dictionary of list of strings and the key also
    # Select random key from dictionary
    wordKey = random.choice(list(wordDict.keys()))
    # Select random word from key's list in the dictionary
...
def playAgain():
    # This function returns True if the player want to play again, otherwise it returns false
