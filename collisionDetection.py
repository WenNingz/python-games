...
# setup bouncer and food data structure
foodCounter = 0
NEWFOOD = 40
FOODSIZE = 20
...
while True:
    ...
    # check if the bouncer has intersect with any food squares
    for food in foods[:]:
